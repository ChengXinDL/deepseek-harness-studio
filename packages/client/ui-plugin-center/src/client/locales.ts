...
export const zh = {
  ...
  presetFufanOfficialHint: '由赋范桌面端开发团队维护的六套内置工作流。',
  ...
  presetSetupReportDetail: '桌面端会检测并在确认后安装 openpyxl、ECharts、Playwright 与 Chromium；若本机缺少 Python 3，需先手动安装。',
  ...
  presetRuntimeChromium: 'Chromium',
...
export const en = {
  ...
  presetFufanOfficialHint: 'Six built-in workflows maintained by the Fufan Desktop team.',
  ...
  presetSetupReportDetail: 'Desktop detects and, after confirmation, installs openpyxl, ECharts, Playwright, and Chromium. Python 3 must be installed manually if missing.',
