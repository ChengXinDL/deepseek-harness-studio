...
export const zh = {
  ...
  managementComplete: '插件操作已完成',
  managementFailed: '插件操作未完成',
  managementInProgress: '正在重启并验证目标插件状态，请保持页面打开。',
  managementCommitted: '目标 Profile 与运行证据均已验证，操作已提交。',
  ...
  installationComplete: '插件已可运行',
  installationFailed: '安装未完成',
  operationInProgress: '正在完成受信任安装事务，请保持页面打开。',
  operationCommitted: 'Host 与客户端运行证据均已通过，安装已提交。',
...
export const en = {
  ...
  managementComplete: 'Plugin operation complete',
  ...
  managementCommitted: 'The target Profile and runtime evidence passed, so the operation is committed.',
  ...
  installationComplete: 'Plugin is ready',
  ...
  operationCommitted: 'Both Host and client runtime evidence passed, so the installation is committed.',
