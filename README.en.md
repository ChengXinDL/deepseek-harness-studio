...
<p align="center"><a href="https://github.com/fufankeji/deepseek-harness-studio/releases/download/desktop-preview-v0.1.0-rc.13/DeepSeek-Harness-Desktop-0.1.0-rc.13-macos-arm64-preview.zip"><strong>Download the macOS arm64 development preview</strong></a> · <a href="https://github.com/fufankeji/deepseek-harness-studio/releases/download/desktop-preview-v0.1.0-rc.13/DeepSeek-Harness-Desktop-Windows-x64-0.1.0-rc.13-Setup.exe"><strong>Download the Windows x64 development preview</strong></a></p>
...
Studio `0.1.0-rc.13` integrates the core and Web capabilities from DeepSeek Harness `0.1.0-rc.8` while retaining Beyondata's Plugin Center, Plugin Discovery, Preset Square, Application Center, themes, and desktop recovery flows. Studio and upstream Harness versions are managed independently.
...
<p align="center"><a href="https://github.com/fufankeji/deepseek-harness-studio/releases/download/desktop-preview-v0.1.0-rc.13/DeepSeek-Harness-Desktop-0.1.0-rc.13-macos-arm64-preview.zip"><strong>Download the macOS arm64 preview</strong></a> · <a href="https://github.com/fufankeji/deepseek-harness-studio/releases/download/desktop-preview-v0.1.0-rc.13/DeepSeek-Harness-Desktop-Windows-x64-0.1.0-rc.13-Setup.exe"><strong>Download the Windows x64 installer</strong></a></p>
