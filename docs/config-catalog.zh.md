...
- `@deepseek-ai/dsh-client-ui-desktop-customization`（[`packages/client/ui-desktop-customization/src/index.ts`](../packages/client/ui-desktop-customization/src/index.ts)）
